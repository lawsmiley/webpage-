        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">contact@kushalandco.com</p>
                </div>
              </div>
          ...
          >
            <form
              ...
              className="bg-dark-light border border-primary/20 rounded-xl p-8 space-y-6"
            >
              <div>
              ...
              <button
                ...
                className="w-full px-8 py-4 bg-primary text-dark font-semibold rounded-lg hover:bg-white transition-all duration-300 hover:shadow-neon flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
